...
public static class GameLocalization
{
    ...
    private static readonly Dictionary<string, string[]> Texts = new Dictionary<string, string[]>
    {
        ...
        { "save_slots.choose_save", new[] { "CHOOSE SAVE SLOT", "WYBIERZ SLOT ZAPISU", "VELG LAGRINGSPLASS", "SPEICHERPLATZ W\u00c4HLEN", "ELIGE UNA RANURA", "V\u00c4LJ SPARPLATS", "V\u00c6LG GEMMEPLADS" } },
        { "save_slots.choose_load", new[] { "CHOOSE SAVE TO LOAD", "WYBIERZ ZAPIS DO WCZYTANIA", "VELG LAGRING", "SPIELSTAND W\u00c4HLEN", "ELIGE UNA PARTIDA", "V\u00c4LJ SPARFIL", "V\u00c6LG GEMNING" } },
        { "save_slots.choose_host", new[] { "CHOOSE SAVE TO HOST", "WYBIERZ ZAPIS DO HOSTOWANIA", "VELG LAGRING FOR VERT", "SPIELSTAND ZUM HOSTEN W\u00c4HLEN", "ELIGE PARTIDA PARA ALOJAR", "V\u00c4LJ SPARFIL ATT VARA V\u00c4RD F\u00d6R", "V\u00c6LG GEMNING TIL V\u00c6RT" } },
        { "save_slots.save_hint", new[] { "Select a slot. An existing save will be overwritten.", "Wybierz slot. Istniej\u0105cy zapis zostanie nadpisany.", "Velg en plass. En eksisterende lagring overskrives.", "W\u00e4hle einen Platz. Ein vorhandener Spielstand wird \u00fcberschrieben.", "Elige una ranura. La partida existente se sobrescribir\u00e1.", "V\u00e4lj en plats. En befintlig sparfil skrivs \u00f6ver.", "V\u00e6lg en plads. En eksisterende gemning overskrives." } },
        { "save_slots.load_hint", new[] { "Select the save you want to continue.", "Wybierz zapis, kt\u00f3ry chcesz kontynuowa\u0107.", "Velg lagringen du vil fortsette.", "W\u00e4hle den Spielstand, den du fortsetzen m\u00f6chtest.", "Elige la partida que quieres continuar.", "V\u00e4lj sparfilen du vill forts\u00e4tta.", "V\u00e6lg den gemning, du vil forts\u00e6tte." } },
        { "save_slots.host_hint", new[] { "Start a new world or select the save the host should load. (N - New Game)", "Rozpocznij nowy \u015bwiat albo wybierz zapis do wczytania. (N - Nowa gra)", "Start en ny verden eller velg lagringen verten skal laste. (N - Nytt spill)", "Starte eine neue Welt oder w\u00e4hle den Spielstand f\u00fcr den Host. (N - Neues Spiel)", "Inicia un mundo nuevo o elige la partida que cargar\u00e1 el anfitri\u00f3n. (N - Nueva partida)", "Starta en ny v\u00e4rld eller v\u00e4lj sparfilen som v\u00e4rden ska ladda. (N - Nytt spel)", "Start en ny verden eller v\u00e6lg den gemning, som v\u00e6rten skal indl\u00e6se. (N - Nyt spil)" } },
        { "save_slots.slot", new[] { "SLOT {0}", "SLOT {0}", "PLASS {0}", "PLATZ {0}", "RANURA {0}", "PLATS {0}", "PLADS {0}" } },
        { "save_slots.empty", new[] { "EMPTY", "PUSTY", "TOM", "LEER", "VAC\u00cdA", "TOM", "TOM" } },
        { "save_slots.damaged", new[] { "SAVE DAMAGED", "USZKODZONY ZAPIS", "SKADET LAGRING", "SPIELSTAND BESCH\u00c4DIGT", "PARTIDA DA\u00d1ADA", "SKADAD SPARFIL", "BESKADIGET GEMNING" } },
        { "save_slots.summary", new[] { "Day {0}  \u2022  ${1}\n{2}", "Dzie\u0144 {0}  \u2022  ${1}\n{2}", "Dag {0}  \u2022  ${1}\n{2}", "Tag {0}  \u2022  ${1}\n{2}", "D\u00eda {0}  \u2022  ${1}\n{2}", "Dag {0}  \u2022  ${1}\n{2}", "Dag {0}  \u2022  ${1}\n{2}" } },
        { "save_slots.save_before_exit", new[] { "SAVE BEFORE LEAVING?", "ZAPISA\u0106 PRZED WYJ\u015aCIEM?", "LAGRE F\u00d8R DU AVSLUTTER?", "VOR DEM VERLASSEN SPEICHERN?", "\u00bfGUARDAR ANTES DE SALIR?", "SPARA INNAN DU AVSLUTAR?", "GEM F\u00d8R DU AFSLUTTER?" } },
        { "save_slots.exit_hint", new[] { "Your progress since the last save will be lost if you leave without saving.", "Post\u0119p od ostatniego zapisu zostanie utracony, je\u015bli wyjdziesz bez zapisywania.", "Fremdrift siden siste lagring g\u00e5r tapt hvis du avslutter uten \u00e5 lagre.", "Fortschritt seit dem letzten Speichern geht ohne Speichern verloren.", "El progreso desde el \u00faltimo guardado se perder\u00e1 si sales sin guardar.", "Framsteg sedan senaste sparningen f\u00f6rloras om du avslutar utan att spara.", "Fremskridt siden sidste gemning mistes, hvis du afslutter uden at gemme." } },
        { "save_slots.save", new[] { "SAVE", "ZAPISZ", "LAGRE", "SPEICHERN", "GUARDAR", "SPARA", "GEM" } },
        { "save_slots.dont_save", new[] { "DON'T SAVE", "NIE ZAPISUJ", "IKKE LAGRE", "NICHT SPEICHERN", "NO GUARDAR", "SPARA INTE", "GEM IKKE" } },
        { "save_slots.cancel", new[] { "CANCEL", "ANULUJ", "AVBRYT", "ABBRECHEN", "CANCELAR", "AVBRYT", "ANNULLER" } },
        ...
        { "area.purchased", new[] { "Purchased", "Kupiono", "Kj\u00f8pt", "Gekauft", "Comprado", "K\u00f6pt", "K\u00f8bt" } },
